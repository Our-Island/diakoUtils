...
public final class DiakoCommand {
    ...
    private static final SuggestionProvider<CommandSourceStack> MODULE_ID_SUGGESTIONS =
            (_, builder) -> SharedSuggestionProvider.suggest(DiakoUtils.MODULES.ids(), builder);
    ...
    private static LiteralArgumentBuilder<CommandSourceStack> listCommand() {
        return Commands.literal("list")
                .requires(source -> DiakoPermissions.hasAny(source, DiakoPermissions.ROOT, DiakoPermissions.LIST))
                .executes(context -> list(context.getSource()));
    }

    private static LiteralArgumentBuilder<CommandSourceStack> statusCommand() {
        return Commands.literal("status")
                .requires(source -> DiakoPermissions.hasAny(source, DiakoPermissions.ROOT, DiakoPermissions.STATUS))
    ...
    private static LiteralArgumentBuilder<CommandSourceStack> enableCommand() {
        return Commands.literal("enable")
                .requires(source -> DiakoPermissions.hasAny(source, DiakoPermissions.ROOT, DiakoPermissions.ENABLE))
                .then(Commands.argument("module", StringArgumentType.word())
                        .suggests(MODULE_ID_SUGGESTIONS)
    ...
    private static LiteralArgumentBuilder<CommandSourceStack> disableCommand() {
        return Commands.literal("disable")
                .requires(source -> DiakoPermissions.hasAny(source, DiakoPermissions.ROOT, DiakoPermissions.DISABLE))
                .then(Commands.argument("module", StringArgumentType.word())
                        .suggests(MODULE_ID_SUGGESTIONS)
                        .executes(context -> setEnabled(
                                context.getSource(),
    ...
    private static LiteralArgumentBuilder<CommandSourceStack> reloadCommand() {
        return Commands.literal("reload")
                .requires(source -> DiakoPermissions.hasAny(source, DiakoPermissions.ROOT, DiakoPermissions.RELOAD))
                .executes(context -> {
    ...
    private static int overview(CommandSourceStack source) {
        source.sendSuccess(() -> header("diakoUtils"), false);
        source.sendSuccess(() -> line("Use ", "/diako list", " to view modules."), false);
        source.sendSuccess(() -> line("Use ", "/diako enable <module>", " or ", "/diako disable <module>", " to change a module."), false);
        return 1;
    }
    ...
    private static int status(CommandSourceStack source, String id) {
        ...
        source.sendSuccess(() -> header(module.displayName()), false);
        source.sendSuccess(() -> labelValue("Module ID", module.id()), false);
        source.sendSuccess(() -> labelValue("State", module.enabled() ? "Enabled" : "Disabled", module.enabled()
                ? ChatFormatting.GREEN
                : ChatFormatting.RED), false);
        source.sendSuccess(() -> labelValue("Description", module.description()), false);
        source.sendSuccess(() -> Component.literal(module.statusLine()).withStyle(ChatFormatting.GRAY), false);
        return 1;
    }
    ...
    private static int setEnabled(CommandSourceStack source, String id, boolean enabled) {
        ...
        source.sendSuccess(
                () -> success((enabled ? "Enabled " : "Disabled ") + id + "."),
                true
        );
        return 1;
    }
    ...
    private static Component moduleLine(IModule module) {
        ...
        return Component.empty()
                ...
                .append(Component.literal(module.id()).withStyle(ChatFormatting.AQUA))
                .append(Component.literal(" — ").withStyle(ChatFormatting.DARK_GRAY))
                .append(Component.literal(module.displayName()).withStyle(ChatFormatting.WHITE))
                .append(Component.literal(" [").withStyle(ChatFormatting.DARK_GRAY))
                .append(Component.literal(state).withStyle(stateColor))
                .append(Component.literal("]").withStyle(ChatFormatting.DARK_GRAY))
                .append(Component.literal("  " + module.description()).withStyle(ChatFormatting.GRAY));
    }

    private static Component header(String title) {
        return Component.empty()
                .append(Component.literal("diakoUtils").withStyle(ChatFormatting.GOLD, ChatFormatting.BOLD))
                .append(Component.literal(" › ").withStyle(ChatFormatting.DARK_GRAY))
    ...
    private static Component labelValue(String label, String value, ChatFormatting valueColor) {
        return Component.empty()
